...
namespace Ejemplo_12.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                MemoriaPlano.Logs.Registrar("INFO", "Sistema de visualizacion de plano satelital activo (Ejemplo 12).");
                MemoriaPlano.Logs.Registrar("INFO", "TDA Matriz Dispersa Ortogonal y Arbol AVL inicializados en memoria RAM.");
                MemoriaPlano.Logs.Registrar("INFO", "Habilitacion de cliente HTTP nativo con modulo de seguridad HTTP Basic Authentication.");
            }
