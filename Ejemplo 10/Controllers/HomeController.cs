...
namespace Ejemplo_10.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                MemoriaPlano.Logs.Registrar("INFO", "Sistema de visualización de plano satelital activo (Ejemplo 10).");
                MemoriaPlano.Logs.Registrar("INFO", "TDA Matriz Dispersa Ortogonal inicializada en memoria RAM.");
                MemoriaPlano.Logs.Registrar("INFO", "Habilitación de cliente HTTP nativo para comunicación entre procesos.");
            }
