...
namespace Ejemplo_9.Controllers
{
    ...
    public class SateliteController : Controller
    {
        ...
        public IActionResult LimpiarMatriz()
        {
            ...
            MemoriaPlano.Logs.Registrar("INFO", "Se purgaron todos los nodos de la Matriz Dispersa.");
            TempData["SuccessMessage"] = "Se ha limpiado el plano espacial (Matriz Dispersa).";
            return RedirectToAction("Index", "Home");
        }
    }
}
